...
Route::get('/available-times/{doctorId}', [AvailableTimeController::class, 'showAvailableTimes']);
Route::post('/appointments/book', [AvailableTimeController::class, 'bookAppointment'])->name('appointments.book');
Route::get('/appointments-book',[AvailableTimeController::class, 'showPageApoitmint'])->name('showPageApoitmint');

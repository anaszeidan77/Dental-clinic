        ...
        <div class="card custom-card">
            ...
            <div class="card-body">
                <ul class="nav nav-tabs mb-3" id="appointmentTabs">
                    <li class="nav-item">
                        <a class="nav-link active" id="all-tab" data-bs-toggle="tab" href="#all">جميع المواعيد</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="scheduled-tab" data-bs-toggle="tab" href="#scheduled">المواعيد المحجوزة</a>
                    </li>
                </ul>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="scheduled">
                        <table class="table table-bordered text-center">
                            ...
                            <tbody>
                                @foreach ($appointments->where('status', 'scheduled') as $appointment)
                                <tr>
                                    <td>{{ $appointment->id }}</td>
                                    <td>{{ $appointment->patient->user->name }}</td>
                                    <td>{{ $appointment->doctor->user->name }}</td>

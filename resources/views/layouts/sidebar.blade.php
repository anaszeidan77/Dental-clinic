 ...
 <aside class="app-sidebar sticky" id="sidebar">
     ...
     <div class="main-sidebar-header">
        <a href="index.html" class="header-logo d-flex align-items-center">
            ...
            <span class="desktop-logo">العيادة السنية</span>
            <span class="toggle-logo">العيادة السنية</span>
            <span class="desktop-dark">العيادة السنية</span>
            <span class="toggle-dark">العيادة السنية</span>
        </a>
    </div>
     ...
     <div class="main-sidebar" id="sidebar-scroll">
         ...
         <nav class="main-menu-container nav nav-pills flex-column sub-open">
             ...
             <ul class="main-menu">
                ...
                <li class="slide">
                    <a href="{{ route('showPageApoitmint') }}" class="side-menu__item">
                        <i class="fa fa-clock"></i>&nbsp; حجز دور
                    </a>
                </li>
                <li class="slide">
                ...
                <li class="slide">
                    <a href="{{ route('available_times.index') }}" class="side-menu__item">
                        <i class="fa fa-clock"></i>&nbsp; إدارة الأوقات المتاحة
                    </a>
                </li>
